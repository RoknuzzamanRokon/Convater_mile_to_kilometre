...
window.config(bg="Gray", pady=50, padx=100)
...
mile_entry01.grid(row=1, column=2)
# mile_entry01.pack()
...
my_label_01.grid(row=2, column=1)
# my_label_01.pack()

# Create a textBox.
my_textbox = Text()
my_textbox.config(width=10, height=1)
my_textbox.grid(row=2, column=2)
# my_textbox.pack()


my_label_02 = Label()
my_label_02.config(text="KM ", bg="Gray", font=("Arial", 10, "bold"))
my_label_02.grid(row=2, column=3)
# my_label_02.pack()
